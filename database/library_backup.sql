...
--
-- Host: localhost    Database: k00999999_framework_16
-- ------------------------------------------------------
...
CREATE TABLE `book` (
  ...
  CONSTRAINT `fk_book_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`) ON UPDATE CASCADE
...
INSERT INTO `book` VALUES (1,'Introduction to PHP','John Smith','9781111111111',3,5,5),(2,'Database Systems','Mary Brown','9782222222222',2,3,3);
...
CREATE TABLE `borrow_record` (
  ...
  KEY `fk_borrow_user` (`UserNr`),
  KEY `fk_borrow_book` (`book_id`),
  CONSTRAINT `fk_borrow_book` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_borrow_user` FOREIGN KEY (`UserNr`) REFERENCES `user` (`UserNr`) ON UPDATE CASCADE
...
INSERT INTO `category` VALUES (1,'Fiction','Fiction books'),(2,'Science','Science books'),(3,'Technology','Technology books');
...
-- Dump completed on 2026-03-19 22:01:05

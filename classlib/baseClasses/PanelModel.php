...
abstract class PanelModel implements PanelModelInterface {
    ...
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID) {  //constructor  
        ...
        $this->user=$user;
        $this->loggedin=$this->user->getLoggedInState();
        $this->db=$db;
    ...
    /**
     * pushes any Objects used by the panel into an array for diagnostic purposes
     * 
     * @param String $pageHead The page heading
     * 
     */
    public function pushPanelModelObject($object){ //set the page heading  
        array_push($this->panelModelObjects,$object);
    }  //end METHOD -   set the page heading    
